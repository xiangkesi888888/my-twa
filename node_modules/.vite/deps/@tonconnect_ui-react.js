...
function createResource(createFn, disposeFn) {
  ...
  const dispose2 = () => __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      logError("Failed to dispose the resource", e2);
    }
  });
...
var BridgeProvider = class _BridgeProvider {
  ...
  openGateways(sessionCrypto, options) {
    return __awaiter(this, void 0, void 0, function* () {
      if (Array.isArray(this.walletConnectionSource)) {
        this.pendingGateways.map((bridge) => bridge.close().catch((e2) => console.error(e2)));
    ...
    try {
      document2.addEventListener("visibilitychange", () => {
        if (document2.hidden) {
          ...
          this.unPauseConnection().catch((e2) => logError("Cannot unpause connection", e2));
        }
      });
    } catch (e2) {
